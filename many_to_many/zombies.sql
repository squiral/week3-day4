...
-- foreigh keys are victim_id and zombie_id
-- primary keys are id in each table
-- bitings (zombies_victims) is the Join Table, if doesn't exist would have to create a Join Table
